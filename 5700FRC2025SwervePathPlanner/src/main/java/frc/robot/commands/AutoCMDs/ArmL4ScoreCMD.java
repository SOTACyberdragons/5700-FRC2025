...
public class ArmL4ScoreCMD extends Command {
  private ArmSubsystem armSubsystem;
  private boolean killed;

  /** Creates a new ElevatorCommand. */
  public ArmL4ScoreCMD(ArmSubsystem armSubsystem) {
  ...
  public void initialize() {
    ...
    armSubsystem.setArmPosition(-0.04);
  }
  ...
  public void execute() {
    ...
    if(Math.abs(armSubsystem.getArmPosition() + 0.04) < 0.01){
      killed = true;
    }
  }
