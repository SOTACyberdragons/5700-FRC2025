...
public class VisionAlgae extends Command {
  ...
  public VisionAlgae(CommandSwerveDrivetrain drivetrain, VisionSubsystem visionsubsystem,
  ...
  public void execute() {
    ...
    if(visionsubsystem.getTargetVisibleLL1() || visionsubsystem.getTargetVisibleLL2()){
      ...
      lateralCommand = lateralPID.calculate(visionsubsystem.getLateral2(),-0.140);
      rotationCommand = rotationPID.calculate(visionsubsystem.getRotation2(), 0.0);
        ...
        lateralCommand = lateralPID.calculate(visionsubsystem.getLateral(),0.1400);
    ...
    forwardCommand = forwardSupplier.get();
      drivetrain.setControl(
      visionRequest.withVelocityX(forwardCommand*0.5)//forwardCommand
              .withVelocityY(-lateralCommand)//-lateralCommand
